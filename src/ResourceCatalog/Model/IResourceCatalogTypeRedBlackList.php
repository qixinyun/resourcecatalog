...
{   
    const TYPE_RED_BLACK_LIST = array(
        ...
        IResourceCatalog::TYPE['XZCFGSXX'] => ISearchableResourceCatalogData::RED_BLACK_LIST['NULL'],
        IResourceCatalog::TYPE['XZXKGSXX'] => ISearchableResourceCatalogData::RED_BLACK_LIST['NULL'],
