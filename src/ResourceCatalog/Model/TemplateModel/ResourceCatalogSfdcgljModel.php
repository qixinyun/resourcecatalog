...
class ResourceCatalogSfdcgljModel
{
    const TEMPLATE = array(
        'SPFYSXK' => array(
            array('englishName'=>'preCertificateNumber', 'name'=>'预售证书编号', 'validationRules'=>array()),
            array('englishName'=>'name', 'name'=>'开发单位', 'validationRules'=>array()),
            ...
            array('englishName'=>'address', 'name'=>'坐落地址', 'validationRules'=>array()),
            array('englishName'=>'licensingAuthority', 'name'=>'许可机关', 'validationRules'=>array()),
            array('englishName'=>'issuingDate', 'name'=>'发证日期', 'validationRules'=>array()),
            array('englishName'=>'city', 'name'=>'所在市', 'validationRules'=>array()),
